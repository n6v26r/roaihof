...
func BuildDataset(root string) (*Dataset, error) {
	...
	b.sourceStatus = append(b.sourceStatus,
		...
		SourceStatus{
			...
			Title:   "ROAI 2026",
			Status:  "ok",
			Detail:  "Imported from the official ROAI 2026 task/results pages, national final PDFs, Baraj and national Nitro judge standings, and Lot IAIO/CEOAI ranking PDFs.",
		...
		SourceStatus{
			...
			Status:  "ok",
			Detail:  "Imported final leaderboard usernames from ROAI 2025/2026 national and 2026 Baraj stages; added only where there was no ambiguity.",
